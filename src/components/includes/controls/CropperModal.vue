    ...
    <div class="d-flex flex-column align-items-center m-3">
        ...
        <div class="mt-1">
            <label :for="disabled ? '' : `file-input-${props.id}`">
                <a type="button" :class="{ disabled: disabled }" class="m-1 btn btn-primary btn-sm"
                    title="upload image"><i class="fas fa-upload"></i></a>
            </label>
            ...
            <a type="button" :class="{ disabled: disabled }" @click="onImageReset()"
                class="m-1 btn btn-secondary btn-sm" title="reset image"><i class="fas fa-undo-alt"></i></a>
        </div>
    </div>
