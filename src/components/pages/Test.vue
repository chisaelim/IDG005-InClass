                        ...
                        <table class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th>Created By</th>
                                    <th>Updated By</th>
                                    <th>Actions <button class="btn btn-sm btn-primary" @click="showModal()">Add</button>
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr v-for="test in tests" :key="test.id">
                                    ...
                                    <td>
                                        <button class="mx-1 btn btn-sm btn-info"
                                            @click="viewTest(test.id)">View</button>
                                        <button class="mx-1 btn btn-sm btn-danger"
                                            @click="removeTest(test.id)">Delete</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
